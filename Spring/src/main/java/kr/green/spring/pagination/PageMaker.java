...
public class PageMaker {
	...
	public void calcData() {
		...
		//ceil 올림 (소수점 첫째 자리에서 올려줌)(반올림 아니고 올림이다. 1,2,3,4여도 올린다.)
		//criteria.getpage() = 3
		// displayPageNum = 10
		...
		/*
		 * 총 콘텐츠 갯수가 61개이고, 한페이지에 컨텐츠 수가 20개일 때 4페이지가 나와야하는데
		 * 4페이지가 나오는지 확인하는게 tempEndPage이다.
		 * 
		 * tempEncPage = (int)(math.ceil(61/20.0))
		 * */
